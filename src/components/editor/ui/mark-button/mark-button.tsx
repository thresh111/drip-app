...
// --- Tiptap UI ---
import type { Mark, UseMarkConfig } from '@/components/editor/ui/mark-button/use-mark';
import { MARK_SHORTCUT_KEYS, useMark } from '@/components/editor/ui/mark-button/use-mark';
