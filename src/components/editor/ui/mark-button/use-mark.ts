...
// --- Icons ---
import { BoldIcon } from '@/components/editor/icons/bold-icon';
import { Code2Icon } from '@/components/editor/icons/code2-icon';
import { ItalicIcon } from '@/components/editor/icons/italic-icon';
import { StrikeIcon } from '@/components/editor/icons/strike-icon';
import { SubscriptIcon } from '@/components/editor/icons/subscript-icon';
import { SuperscriptIcon } from '@/components/editor/icons/superscript-icon';
import { UnderlineIcon } from '@/components/editor/icons/underline-icon';
