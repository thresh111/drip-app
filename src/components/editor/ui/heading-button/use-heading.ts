...
// --- Icons ---
import { HeadingOneIcon } from '@/components/editor/icons/heading-one-icon';
import { HeadingTwoIcon } from '@/components/editor/icons/heading-two-icon';
import { HeadingThreeIcon } from '@/components/editor/icons/heading-three-icon';
import { HeadingFourIcon } from '@/components/editor/icons/heading-four-icon';
import { HeadingFiveIcon } from '@/components/editor/icons/heading-five-icon';
import { HeadingSixIcon } from '@/components/editor/icons/heading-six-icon';
